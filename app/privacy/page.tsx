    ...
    <>
      ...
      <main className="relative bg-void-black min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-12">
            <p className="text-xs font-mono tracking-widest uppercase mb-3" style={{ color: 'rgb(0,240,255)' }}>
              Legal
            </p>
            <h1 className="font-heading text-4xl sm:text-5xl font-bold mb-4" style={{ color: '#f8f9fa' }}>
              Privacy Policy
            </h1>
          ...
          <div className="prose-section space-y-10 text-text-secondary text-sm sm:text-base leading-relaxed">
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>1. Who I Am</h2>
              <p>
              ...
              <p className="mt-3">
                Contact: <a href="mailto:masabfarooque1122@gmail.com" className="underline underline-offset-2 hover:opacity-80 transition-opacity" style={{ color: 'rgb(0,240,255)' }}>masabfarooque1122@gmail.com</a>
              </p>
            </section>

            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>2. What Data I Collect</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>3. How I Use Your Data</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>5. Cookies</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>6. Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>7. Your Rights</h2>
              ...
              <p className="mt-3">To exercise any of these rights, email <a href="mailto:masabfarooque1122@gmail.com" className="underline underline-offset-2 hover:opacity-80 transition-opacity" style={{ color: 'rgb(0,240,255)' }}>masabfarooque1122@gmail.com</a> and I will respond within 72 hours.</p>
            </section>

            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>8. Changes to This Policy</h2>
            ...
            <div className="pt-6 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
              <Link href="/terms" className="text-sm underline underline-offset-2 hover:opacity-80 transition-opacity mr-6" style={{ color: 'rgb(139,92,246)' }}>
                Terms of Service
              </Link>
              <Link href="/contact" className="text-sm underline underline-offset-2 hover:opacity-80 transition-opacity" style={{ color: 'rgb(0,240,255)' }}>
                Contact Me
              </Link>
            </div>
