...
const WorldMap = dynamic(() => import('./WorldMap'), {
  ssr: false,
  loading: () => (
    <div className="relative w-full py-20 sm:py-24 md:py-32 px-4" style={{ backgroundColor: '#0a0a0f' }}>
      <div className="max-w-7xl mx-auto animate-pulse">
        ...
        <div className="h-64 sm:h-96 rounded-2xl" style={{ background: 'rgba(255,255,255,0.04)' }} />
      </div>
    </div>
  ),
});
