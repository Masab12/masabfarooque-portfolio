    ...
    <>
      ...
      <main className="relative bg-void-black min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-12">
            <p className="text-xs font-mono tracking-widest uppercase mb-3" style={{ color: 'rgb(139,92,246)' }}>
              Legal
            </p>
          ...
          <div className="space-y-10 text-text-secondary text-sm sm:text-base leading-relaxed">
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>1. About These Terms</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>2. Scope of Work</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>3. Payment</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>4. Revisions & Delivery</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>5. Intellectual Property</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>6. Confidentiality</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>7. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>8. Cancellation</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>9. Governing Law</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3" style={{ color: '#f8f9fa' }}>10. Contact</h2>
              <p>
                Questions about these terms? Email me at{' '}
                <a href="mailto:masabfarooque1122@gmail.com" className="underline underline-offset-2 hover:opacity-80 transition-opacity" style={{ color: 'rgb(0,240,255)' }}>
            ...
            <div className="pt-6 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
              <Link href="/privacy" className="text-sm underline underline-offset-2 hover:opacity-80 transition-opacity mr-6" style={{ color: 'rgb(0,240,255)' }}>
                Privacy Policy
              </Link>
              <Link href="/contact" className="text-sm underline underline-offset-2 hover:opacity-80 transition-opacity" style={{ color: 'rgb(139,92,246)' }}>
                Contact Me
              </Link>
            </div>
