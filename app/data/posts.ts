...
export const posts: Post[] = [
  {
    ...
    readingMinutes: 11,
    related: ['wordpress-to-nextjs-migration-cost', 'wordpress-to-nextjs-migration-checklist', 'wordpress-vs-nextjs'],
    sections: [
  ...
  },
  {
    ...
    readingMinutes: 12,
    related: ['wordpress-vs-sanity-headless-cms', 'hosting-headless-wordpress', 'wordpress-plugins-in-nextjs'],
    sections: [
  ...
  },
  {
    ...
    readingMinutes: 12,
    related: ['wordpress-to-nextjs-migration-timeline', 'wordpress-to-nextjs-migration', 'woocommerce-to-nextjs'],
    sections: [
  ...
  },
  {
    ...
    summary:
      'A straight comparison of WordPress and Next.js for real sites: what the plugin model actually costs you, where each one hits a ceiling, and how to decide without paying to rebuild twice.',
    standfirst:
      'Both will serve your pages. Only one of them matches how your site gets used.',
    topic: 'architecture',
    published: '2026-09-07',
    readingMinutes: 14,
    related: ['wordpress-plugins-in-nextjs', 'wordpress-to-nextjs-migration'],
    sections: [
      { id: 'what-you-are-choosing', label: 'What you are actually choosing' },
      { id: 'where-the-market-is', label: 'Where WordPress actually stands' },
      { id: 'the-plugin-bill', label: 'The plugin bill nobody quotes' },
      { id: 'the-speed-ceiling', label: 'The speed ceiling' },
      { id: 'where-wordpress-wins', label: 'Where WordPress still wins' },
      { id: 'the-third-option', label: 'The option most people miss' },
      { id: 'how-to-decide', label: 'Deciding in ten minutes' },
      { id: 'faq', label: 'Questions people ask me' },
      { id: 'resources', label: 'Resources' },
    ],
  },
  {
    slug: 'wordpress-plugins-in-nextjs',
    title: 'What happens to your WordPress plugins when you move to Next.js',
    summary:
      'The question that stalls most migrations. What each common WordPress plugin is really doing, which ones vanish on their own, which become a few lines of code, and which turn into a second project.',
    standfirst:
      'Twenty eight active plugins is not twenty eight problems. Most of them stop existing.',
    topic: 'migration',
    published: '2026-09-07',
    readingMinutes: 12,
    related: ['wordpress-vs-nextjs', 'wordpress-to-nextjs-migration-checklist'],
    sections: [
      { id: 'sort-before-you-price', label: 'Sort the list before you price it' },
      { id: 'four-piles', label: 'The four piles' },
      { id: 'the-mapping', label: 'What replaces what' },
      { id: 'forms', label: 'Forms, in full' },
      { id: 'seo-plugin', label: 'The SEO plugin' },
      { id: 'performance-stack', label: 'The performance stack' },
      { id: 'the-hard-ones', label: 'The ones that are genuinely hard' },
      { id: 'audit-your-list', label: 'Auditing your own list' },
      { id: 'resources', label: 'Resources' },
    ],
  },
  {
    ...
    summary:
      'Headless WooCommerce with Next.js: which half of a store moves cleanly, why the cart is the real project, the checkout decision that saves most of the budget, and when not to do it at all.',
    standfirst:
      'The catalogue is the easy half. Stores go wrong at the cart.',
    topic: 'migration',
    published: '2026-09-07',
    readingMinutes: 13,
    related: ['wordpress-vs-nextjs', 'wordpress-to-nextjs-migration-cost'],
    sections: [
      { id: 'two-halves', label: 'A store is two halves' },
      { id: 'the-catalogue', label: 'The catalogue moves cleanly' },
      { id: 'the-cart', label: 'The cart is the project' },
      { id: 'checkout', label: 'The checkout decision' },
      { id: 'what-it-costs', label: 'What this actually costs' },
      { id: 'when-not-to', label: 'When to leave the store alone' },
      { id: 'the-order', label: 'If you do it, do it in this order' },
      { id: 'faq', label: 'Questions people ask me' },
      { id: 'resources', label: 'Resources' },
    ],
  },
